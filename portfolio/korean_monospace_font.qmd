...
- 명확한 문자 구분: 0과 O, 1과 l 같은 글자들이 혼동되지 않도록 각 문자의 고유한 형태가 뚜렷해야 합니다. 예를 들어, 0에는 슬래시나 점이 있어 O와 구별됩니다.
...
![](./fonts_preview/MeD2.png){width=80% fig-align="center"}
[MeD2 repository](https://github.com/partrita/MeD2)

### Jetbrain mono + D2Coding

![](./fonts_preview/JBD2.png){width=80% fig-align="center"}
[JBD2 repository](https://github.com/partrita/JBD2)

### Fira Code + D2Coding

![](./fonts_preview/FiraD2.png){width=80% fig-align="center"}
[FiraD2 repository](https://github.com/partrita/FiraD2)

### MonoLisa + D2Coding

![](./fonts_preview/MLD2.png){width=80% fig-align="center"}
[MLD2 repository](https://github.com/partrita/MLD2)