...
title: "Pixi: "
author: "Taeyoon kim"
categories: [python, mamba, anaconda, conda, pixi, R]
draft: false
date: "2024-02-28"
---

![](thumbnail.svg){width=50% fig-align="center"}
...
원하는 패키지는 아래 명령어로 추가합니다. [Prefix.dev](https://prefix.dev/)에서 검색을 통해 지원되는 패키지와 명령어를 확인할 수 있습니다.
...
:::{.callout-note}
`pixi.lock`파일은 `pixi add`를 실행하거나 수동으로 `pixi.toml` 파일을 변경한 후 `pixi install`을 실행할 때 생성됩니다.
:::
